...
// alHara hosts nothing itself, so its recorded shows are read from Mixcloud.
// The wire shapes for that are shared with Radio 80000 and live in
// `MixcloudArchive.swift`; what follows is what alHara makes of them.
